...
data FHProp where 
  FH :: Assertion -> Com -> Assertion -> FHProp 

data FHProof where 
  FHSkip    :: Assertion -> FHProof 
  FHAssign  :: Assertion -> Vname -> AExp -> FHProof 
  FHSeq     :: Assertion -> Com -> Assertion -> Com -> Assertion -> FHProof -> FHProof -> FHProof 
  FHIf      :: Assertion -> Assertion -> BExp -> Com -> Com -> FHProof -> FHProof -> FHProof
  FHWhile   :: Assertion -> BExp -> Com -> FHProof -> FHProof 
  FHConPre  :: Assertion -> Assertion -> Assertion -> Com -> Valid -> FHProof -> FHProof 
  FHConPost :: Assertion -> Assertion -> Assertion -> Com -> FHProof -> Valid -> FHProof
